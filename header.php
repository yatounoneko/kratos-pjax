...
<html <?php language_attributes(); ?>>
  <head>
    ...
    <style><?php
        ...
        if(kratos_option('background_mode')=='image') echo '@media(min-width:768px){.kratos-hentry,.navigation div,.comments-area .comment-list li,#kratos-widget-area .widget,.comment-respond{background-color:rgba(253,253,253,.85)}.comment-list .children li{background-color:rgba(255,253,232,.7)}body.custom-background{background-image:url('.kratos_option('background_index_image').');background-size:cover;background-attachment:fixed}}';
